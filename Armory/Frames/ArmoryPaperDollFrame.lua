--[[
    ...
    Revision: 703 2015-08-31T20:37:15Z
...
function ArmoryPaperDollFrame_SetCritChance(statFrame, unit)
	...
	if ( Armory:GetCritChanceProvidesParryEffect() ) then
        ...
        local critRating = Armory:GetCombatRating(rating);
        statFrame.tooltip2 = format(CR_CRIT_PARRY_RATING_TOOLTIP, BreakUpLargeNumbers(critRating), critChance, Armory:GetCombatRatingBonusForCombatRatingValue(CR_PARRY, critRating));
	else
