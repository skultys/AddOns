...
L["ARMORY_CMD_SET_USECLASSCOLORS_MENUTEXT"] = "Class colors in dropdown"
L["ARMORY_CMD_SET_USECLASSCOLORS_TEXT"] = "use class colors in character dropdown"
L["ARMORY_CMD_SET_USECLASSCOLORS_TOOLTIP"] = "If enabled, class colors are used when displaying character names in the selection dropdown."
