...
L["Auto Show/Hide"] = "Auto Show/Hide" -- Requires localization
L["Choose the button modifier to use the world markers (flares)."] = "Choose the button modifier to use the world markers (flares)." -- Requires localization
L["Choose the orientation of the raid markers bar."] = "Choose the orientation of the raid markers bar." -- Requires localization
L["Click to clear the mark."] = "Click to clear the mark." -- Requires localization
...
L["Click to mark the target."] = "Click to mark the target." -- Requires localization
L["Click to mark the target.\
%sClick to place a flare."] = "Click to mark the target.\
%sClick to place a flare." -- Requires localization
L["Control"] = "Control" -- Requires localization
L["ElvUI Raid Markers"] = "ElvUI Raid Markers" -- Requires localization
L["Hide in Pet Battle"] = "Hide in Pet Battle" -- Requires localization
L["Horizontal"] = "Horizontal" -- Requires localization
L["Orientation"] = "Orientation" -- Requires localization
L["Plugins by |cff9382c9Lockslap|r"] = "Plugins by |cff9382c9Lockslap|r" -- Requires localization
L["Raid Markers"] = "Raid Markers" -- Requires localization
L["Raid Markers Bar"] = "\235\160\136\236\157\180\235\147\156 \235\167\136\236\187\164 \235\176\148" -- Needs review
...
L["Show Raid Markers Bar"] = "Show Raid Markers Bar" -- Requires localization
...
L["Toggle the raid markers bar."] = "Toggle the raid markers bar." -- Requires localization
